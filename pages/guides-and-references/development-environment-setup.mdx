...
Create an account if you do not have one. Choose a username that will work well for your professional portfolio. Avoid using a username that contains the word "SAIT". My GitHub username is `oakinbode` and you can view my public repositories here: [https://github.com/oakinbode/](https://github.com/oakinbode/).
