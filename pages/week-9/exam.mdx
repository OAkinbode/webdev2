...
- **Exam Format**: The exam consists of 10-15 questions most of which will be multiple choice questions. You will be required to review code within a GitHub repository and answer questions related to it. You may find it helpful to clone and run the project.
...
For these questions, please refer to the `/week-7` folder of the GitHub repository `webdev-2-demos` found here: https://github.com/warsylewicz/webdev2-demos/tree/master/app/week-7

It is recommended to clone the [repository](https://github.com/warsylewicz/webdev2-demos) and run the application locally to help answer the questions.
