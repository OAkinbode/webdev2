...
Let's test your development environment setup by accessing a sample app called webdev2_class_demo. The code for the app can be found on [GitHub](https://github.com/OAkinbode/Assignment1_welcome.git).
