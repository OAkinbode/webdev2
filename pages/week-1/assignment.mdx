...
Let's test your development environment setup by accessing a sample app called webdev2_class_demo. The code for the app can be found on [GitHub](https://github.com/OAkinbode/webdev2_class_demo.git) and is available to you for the duration of the course.
